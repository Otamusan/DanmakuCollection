...
export class Particle {
    ...
    constructor(color: Color, vector: Coord, coord: Coord, size: number, remain: number, list: Array<PFunc>, shape: Shape, radian: number, alpha: number) {
        this.color = color;
        this.vector = vector;
        this.coord = coord;
        this.size = size;
